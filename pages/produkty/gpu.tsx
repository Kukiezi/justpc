...
import GPUList from "../../components/pcbuilder/productsTable/gpu/GPUList";

export default function GPU(props: any) {
...
export const getServerSideProps: GetServerSideProps = async (ctx: any) => {
    const res = await fetch("http://localhost:3000/api/v1/gpus", {
        method: "get",
    })
    .then((res) => res.json())
    .catch((error) => error)
