...
import MotherboardList from "../../components/pcbuilder/productsTable/motherboard/MotherboardList";
        ...
        <div className="">
            <div className="grid grid-cols-12">
                ...
                <div className="col-span-12 md:border-solid px-3 py-6 md:border-l md:border-black md:border-opacity-25 h-full pb-12 md:col-span-10">
                    <MotherboardList motherboards={props} />
                </div>
            </div>
        </div>
    );
...
export const getServerSideProps: GetServerSideProps = async (ctx: any) => {
    const res = await fetch("http://localhost:3000/api/v1/motherboards", {
        method: "get",
    })
    .then((res) => res.json())
    .catch((error) => error)
